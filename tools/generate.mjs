...
const PLUGIN_DESCRIPTION = [
  ...
  "<p><b>Noctis</b></p>",
  "<p>",
  '  <img src="https://raw.githubusercontent.com/iceholic/noctis-jetbrains/main/screenshots/noctis-application.png"',
  '       alt="Noctis dark code preview" width="720">',
  "</p>",
  "<p><b>Noctis Lux</b></p>",
  "<p>",
  '  <img src="https://raw.githubusercontent.com/iceholic/noctis-jetbrains/main/screenshots/noctis-lux-application.png"',
  '       alt="Noctis Lux light code preview" width="720">',
  "</p>",
  "<p>",
